...
public class OpenChestCavityTask extends Task {
    ...
    public void fillConfigGroup(ConfigGroup config) {
        ...
        config.addEnum("entity", this.entity, (v) -> {
            this.entity = v;
        }, NameMap.of(PLAYER, ids).nameKey((v) -> {
    ...
    public void chestCavityOpened(TeamData teamData, LivingEntity entity) {
        if (!teamData.isCompleted(this) && this.entity.equals(RegistrarManager.getId(entity.getType(), Registries.ENTITY_TYPE))) {
